# Generated by Django 3.2 on 2022-08-19 12:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_enable', models.BooleanField(default=True, verbose_name='is enable')),
                ('categories', models.ManyToManyField(blank=True, related_name='categories', to='products.Category', verbose_name='categories')),
            ],
            options={
